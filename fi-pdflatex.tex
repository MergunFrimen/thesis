...
The plugin is implemented as a Typescript class that extends the Plugin superclass provided by Mol*. The plugin class is then registered with the Mol* viewer, which allows the plugin to be used. The plugin class implements the following methods:
